...
public class CommentCommands {
    ...
    public CommentCommands(CommentService commentService, BooksService booksService, IOService ioService) {
    ...
    public void save(long id, String message, long id_book) {
        Optional<Book> bookOptional = booksService.getBookById(id_book);
        if (bookOptional.isPresent()) {
            Comment comment = new Comment(id, message, new Date(), bookOptional.get());
